...
namespace ClassObjectstance
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // R-value : Human 객체 생성후 변환된 객체 참조
...
class Human
{
    ...
    // 캡슐화 : 멤버들에 보호처리 / 연산처리 등을 해주기위한 과정
    public int age = 1;
    ...
    // 참조 타입 : 할당된 메모리의 주소를 통해서 간접적으로 테이터를 쓰고 읽는 형태

    // 생성자
    // 해당 클래스타입이 객체를 합영역에다가 할당한 다음 해당 영역의 참조를 반환하는 함수
    public Human ()
    {
    ...
    //소멸자
    // 합영역에 할당되었던 객체를 메모리에서 해제하기 위해 호출하는 함수
    ~Human ()
    {
